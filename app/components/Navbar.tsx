            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-64 rounded-lg border border-slate-200 bg-white shadow-lg">
                ...
                <div className="border-b border-slate-200 px-4 py-3">
                  ...
                  <p className="font-semibold text-slate-900 break-all">{currentUser}</p>
                </div>
                ...
                {renameMode ? (
                  <div className="px-4 py-3 border-b border-slate-200">
                    ...
                    <input
                      ...
                      autoFocus
                      className="w-full px-2 py-1.5 text-sm border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mb-2"
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2.5 text-left text-sm text-slate-700 hover:bg-slate-50 transition-colors flex items-center gap-2 border-b border-slate-200"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2.5 text-left text-sm text-red-600 hover:bg-red-50 transition-colors flex items-center gap-2 border-t border-slate-200"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
